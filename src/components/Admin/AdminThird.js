...
function AdminThird() {
  ...
  useEffect(()=>{
    const realFour = async () => {
      ...
      setAdminDetails(request.data.allHost);
    }
    realFour();
  },[]);
  ...
  const Navigate = useNavigate();
    return (
      <div className='admin-third__page'>
          <div className='admin-third__info'>
             <div className="admin-third__info-left">
              <div className='incase-you-know'>
                  ...
                  <div className='adminThirdMenuBar' onClick={handleMenuBar}><h2 style={{ display: 'flex', alignItems: 'center' }}><MoreHoriz /> </h2></div>
              </div>
             ...
             <div className="admin-third__info-right">
                <h4>Number of admins: {adminDetails.length}</h4>
                <div className="admin-third__info-right-rightFilter">
                ...
                <table>
                  ...
                  <tbody>
                  {adminDetails && adminDetails.filter((val) => {
                    if(searchFul === "") {
                      return val
                    }
