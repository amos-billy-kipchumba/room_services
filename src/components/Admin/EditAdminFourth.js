...
function EditAdminFourth() {
  ...
  const Navigate = useNavigate();
    return (
      <div className='edit_admin_fourth__page'>
  
          <div className='edit_admin_fourth__info'>
             <div className="edit_admin_fourth__info-left">
...
export default EditAdminFourth