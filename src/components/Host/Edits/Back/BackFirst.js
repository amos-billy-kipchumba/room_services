  ...
  const handleUpdate = (e) => {
    ...
    axios.post(url,data).then((res) => {
      if(res.data.status === 200) {
        Navigate('/add-house-host-page-two');
      }
    });
    ...
    return (
      <div className='back-first__page'>
  
          <div className='back-first__info'>
             <div className="back-first__info-left">
              <div className='incase-you-know'>
                  ...
                  <div className='backFirstMenuBar' onClick={handleMenuBar}><h2 style={{ display: 'flex', alignItems: 'center' }}><MoreHoriz /> </h2></div>
              </div>
              {showMenuBar ?
              <p>Navigation</p>
              :
             ...
             <div className="back-first__info-right">
              <form className="back-first__info-right-block" encType='multipart/form-data' onSubmit={handleUpdate}>
                <div className="back-first__info-right-image-container">
                  <div className="back-first__info-right-image">
                ...
                <div className="back-first__info-right-input">
                  <label>Title</label>
