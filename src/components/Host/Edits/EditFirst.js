          ...
          <div className='edit-first__info'>
             ...
             <div className="edit-first__info-right">
              <form className="edit-first__info-right-block" encType='multipart/form-data' onSubmit={handleUpdate}>
                ...
                <Button onClick={()=> {
                  Navigate(`/edit-second?name=${editTitle}&id=${paramaId}`,{state:{
                    paramaId: paramaId,
                    title: editTitle,
                  }
                  });
                ...
                <Button onClick={()=> {
                  Navigate(`/edit-third?name=${editTitle}&id=${paramaId}`,{state:{
                    paramaId: paramaId,
                    title: editTitle,
                  }
                  });
                ...
                <Button onClick={()=> {
                  Navigate(`/edit-four?name=${editTitle}&id=${paramaId}`,{state:{
                    paramaId: paramaId,
                    title: editTitle,
                  }
                  });
                ...
                <Button onClick={()=> {
                  Navigate(`/edit-five?name=${editTitle}&id=${paramaId}`,{state:{
                    paramaId: paramaId,
                    title: editTitle,
                  }
                  });
