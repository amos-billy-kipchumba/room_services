...
function MobileHome() {
    ...
    useEffect(()=>{
        function fanyaMambo() {
            for(var i=0; i < matchSearch.length; i++) {
                if(matchSearch[i].house_type === "mobile house") {
                    setShowReal(true);
                    break;
                }
            }
  ...
  return (
    <div className='mobile-home'>
        ...
        <div className='mobile-home__info'>
