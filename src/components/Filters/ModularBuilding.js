    ...
    useEffect(()=>{
        function fanyaMambo() {
            for(var i=0; i < matchSearch.length; i++) {
                if(matchSearch[i].house_type === "modular building") {
                    setShowReal(true);
                    break;
                }
            }
...
export default ModularBuilding