...
function HouseBarn() {
    ...
    useEffect(()=>{
        function fanyaMambo() {
            for(var i=0; i < matchSearch.length; i++) {
                if(matchSearch[i].house_type === "house barn") {
                    setShowReal(true);
                    break;
                }
            }
  ...
  return (
    <div className='house-barn'>
        {showFilter !== false ?
            <div className='house_barn_overlay'>
                <div className='heyo_before' ref={overlayRef}>
                    <p>Search filters according to house type</p>
                    <Button onClick={()=>{
                        setShowFilter(!showFilter);
                    }}>close <Close /></Button>
                    <div className='HEYohouse-barn'>
                        <Button onClick={()=>{
        ...
        <div className='house-barn__info'>
