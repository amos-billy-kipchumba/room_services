...
function TownHouse() {
    ...
    useEffect(()=>{
        function fanyaMambo() {
            for(var i=0; i < matchSearch.length; i++) {
                if(matchSearch[i].house_type === "town house") {
                    setShowReal(true);
                    break;
                }
            }
  ...
  return (
    <div className='town-house'>
        {showFilter !== false ?

            <div className='town_house_overlay'>
                <div className='heyo_before' ref={overlayRef}>
                    <p>Search filters according to house type</p>
                    <Button onClick={()=>{
                        setShowFilter(!showFilter);
                    }}>close <Close /></Button>
                    <div className='HEYotown-house'>
                        <Button onClick={()=>{
        ...
        <div className='town-house__info'>
