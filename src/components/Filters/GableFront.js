...
function GableFront() {
    ...
    useEffect(()=>{
        function fanyaMambo() {
            for(var i=0; i < matchSearch.length; i++) {
                if(matchSearch[i].house_type === "gable-front") {
                    setShowReal(true);
                    break;
                }
            }
  ...
  return (
    <div className='gable-front'>
        ...
        <div className='gable-front__info'>
