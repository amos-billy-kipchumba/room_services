...
function LongHouse() {
    ...
    useEffect(()=>{
        function fanyaMambo() {
            for(var i=0; i < matchSearch.length; i++) {
                if(matchSearch[i].house_type === "long house") {
                    setShowReal(true);
                    break;
                }
            }
  ...
  return (
    <div className='long-house'>
        {showFilter !== false ?
            <div className='long_house_overlay'>
                <div className='heyo_before' ref={overlayRef}>
                    <p>Search filters according to house type</p>
                    <Button onClick={()=>{
                        setShowFilter(!showFilter);
                    }}>close <Close /></Button>
                    <div className='HEYolong-house'>
                        <Button onClick={()=>{
        ...
        <div className='long-house__info'>
