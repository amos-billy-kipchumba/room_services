...
function SplitLevel() {
    ...
    useEffect(()=>{
        function fanyaMambo() {
            for(var i=0; i < matchSearch.length; i++) {
                if(matchSearch[i].house_type === "split-level") {
                    setShowReal(true);
                    break;
                }
            }
  ...
  return (
    <div className='split-level'>
        ...
        <div className='split-level__info'>
